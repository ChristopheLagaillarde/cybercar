...
public class ApiRSA {
	...
	public static PublicKey turnByteArrayPkInPublicKey(byte[] pkEnByte) throws Exception {

		KeyFactory kf = KeyFactory.getInstance("RSA"); 
		pk = kf.generatePublic(new X509EncodedKeySpec(pkEnByte));

		return pk;
	}

	public static PrivateKey turnByteArraySkInPrivateKey(byte[] skEnByte) throws Exception {

		KeyFactory kf = KeyFactory.getInstance("RSA"); 
		//sk = kf.generatePrivate(new X509EncodedKeySpec(skEnByte));
		sk = kf.generatePrivate(new PKCS8EncodedKeySpec(skEnByte));
		return sk;
	}
	...
	public static String sign(String texteClair, PrivateKey priveSK) throws Exception {
		...
		privateSignature.update(texteClair.getBytes(getUtf8()));
	...
	public static boolean verify(String texteClair, String signature, PublicKey publicPK) throws Exception  {
		...
		publicSignature.update(texteClair.getBytes(getUtf8())); // re-signe pour obtenir la signature candidate
